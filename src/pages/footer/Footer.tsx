...
export default function Footer() {
  return (
    <footer className="bg-secondary/40 border-t border-gray-300">
      <ScrollToTop />

      <div className="max-w-7xl mx-auto px-6 py-12 grid gap-10 md:grid-cols-4">
        <div>
          <h2 className="text-2xl font-bold mb-3">WebNoticias</h2>
      ...
      <div className="border-t border-gray-300 text-center text-xs text-neutral-500 py-4">
