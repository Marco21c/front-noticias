export const newsMock = [
  {
    _id: "1",
    title: "Argentina acelera la digitalización del Estado",
    slug: "argentina-digitalizacion-estado",
    summary:
  ...
  {
    _id: "2",
    title: "Mercado Libre rompe récord histórico en Wall Street",
    slug: "mercado-libre-record-wall-street",
    summary:
  ...
  {
    _id: "3",
    title: "Nuevo framework promete revolucionar el desarrollo web",
    slug: "nuevo-framework-desarrollo-web",
    summary:
  ...
  {
    _id: "4",
    title: "Aumenta la demanda de autos usados en Argentina",
    slug: "demanda-autos-usados-argentina",
    summary:
    ...
    status: "published",
    publicationDate: new Date("2026-01-08"),
    source: ""
  },
]
